...
The purpose of this library is to make the verification functionality that is critical to UltimateOnlineCash's consensus available to other applications, e.g. to language bindings.
...
- [NUltimateOnlineCash](https://github.com/NicolasDorier/NUltimateOnlineCash/blob/master/NUltimateOnlineCash/Script.cs#L814) (.NET Bindings)

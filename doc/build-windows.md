...
Below are some notes on how to build UltimateOnlineCash Core for Windows.
...
way. This will install to `c:\workspace\ultimateonlinecash`, for example:

    make install DESTDIR=/mnt/c/workspace/ultimateonlinecash

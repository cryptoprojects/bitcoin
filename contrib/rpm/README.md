...
The RPM spec file provided here is for UltimateOnlineCash-Core 1.0.0 and builds on CentOS
...
[UltimateOnlineCash git repository](https://github.com/cryptoprojects/ultimateonlinecash) but are not part of
...
in the bitcoin git repository. At present only an SVG version of the UltimateOnlineCash
icon is used.
...
needed when 0.12.1 is released, a proper fix is already in the UltimateOnlineCash git
master branch.
...
idea to build UltimateOnlineCash Core against a static version of that library compiled
...
UltimateOnlineCash-Core against OpenSSL or use a patched version of Boost in the build
system.
...
packaging UltimateOnlineCash for Fedora at least since 2012.
